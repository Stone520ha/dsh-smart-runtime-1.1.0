export function discoverSubagentService(ctx) {
    if (!ctx || typeof ctx !== 'object')
        return undefined;
    const direct = ctx.subagents;
    if (direct && typeof direct === 'object' && typeof direct.list === 'function') {
        return direct;
    }
    ...
    if (typeof getter === 'function') {
        try {
            ...
            if (resolved && typeof resolved === 'object' && typeof resolved.list === 'function') {
                return resolved;
            }
        }
        catch {
...
export function delegationAdvice(strategy, service, config) {
...
function isolationRule(strategy) {
    if (strategy === 'code') {
